...
(1, 2, '2021-01-05', 'Credit'),
(2, 3, '2012-01-15', 'Paypal'),
(3, 4, '2020-12-01', 'Steam Wallet'),
(4, 5, '2021-05-10', 'Debit'),
(5, 6, '2019-11-11', 'Credit'),
(6, 7, '2020-12-25', 'Paypal'),
(7, 8, '2018-11-30', 'Debit'),
(8, 9, '2017-06-14', 'Steam Wallet'),
(9, 10, '2020-03-12', 'Credit'),
(10, 11, '2016-04-15', 'Paypal'),
(11, 12, '2021-06-08', 'Debit'),
(12, 13, '2021-01-05', 'Credit'),
(13, 14, '2020-06-20', 'Paypal'),
(14, 15, '2018-04-25', 'Steam Wallet'),
(15, 16, '2019-04-01', 'Debit'),
(16, 17, '2020-11-10', 'Credit'),
(17, 18, '2018-03-22', 'Paypal'),
(18, 19, '2020-12-01', 'Steam Wallet'),
(19, 20, '2015-09-05', 'Debit'),
(20, 1, '2020-11-15', 'Credit');
...
(8, 9, '2024-03-01', 220),
(9, 10, '2023-08-01', 50),
(10, 11, '2023-09-01', 270),
(11, 12, '2023-10-01', 90),
(12, 13, '2023-11-01', 130),
(13, 14, '2024-04-01', 300),
(14, 15, '2024-05-01', 200),
(15, 16, '2023-12-01', 160),
(16, 17, '2024-06-01', 120),
(17, 18, '2023-02-01', 70),
(18, 19, '2023-03-01', 250),
(19, 20, '2023-01-01', 180),
(20, 1, '2023-04-01', 190);

INSERT INTO game_achievement (game_id, achieve_desc, achieve_title)
VALUES 
(1, 'Complete the prologue', 'Prologue Master'),
(2, 'Defeat the final boss', 'Dragon Slayer'),
(3, 'Solve all puzzles', 'Puzzle Master'),
(4, 'Complete the main quest', 'Valhalla King'),
(5, 'Complete the game 100%', 'Ultimate Cowboy'),
(6, 'Win the championship', 'Champion'),
(7, 'Complete all side quests', 'Side Quest Hero'),
(8, 'Achieve rank 1', 'Top Player'),
(9, 'Win 10 matches', 'Battle Royale Master'),
(10, 'Complete all levels', 'Level Master'),
(11, 'Find all secrets', 'Secret Finder'),
(12, 'Defeat the main villain', 'Hero'),
(13, 'Complete the story', 'Storyteller'),
(14, 'Max out all stats', 'God of War'),
(15, 'Defeat the hardest boss', 'Sekiro Master'),
(16, 'Deliver all packages', 'Delivery Expert'),
(17, 'Discover all islands', 'Explorer'),
(18, 'Complete the game', 'Dragon Master'),
(19, 'Complete all missions', 'Stealth Master'),
(20, 'Win 10 matches', 'Cold War Veteran'),
(1, 'Complete the game in under 10 hours', 'Speedrunner'),
(2, 'Defeat all bosses', 'Boss Hunter'),
(3, 'Find all collectibles', 'Collector'),
(4, 'Unlock all characters', 'Character Collector'),
(5, 'Complete all levels without dying', 'Perfectionist'),
(6, 'Score a goal in every match', 'Goal Machine'),
(7, 'Defeat the final boss in under 5 minutes', 'Speedrunner'),
(8, 'Win 50 matches', 'Veteran'),
(9, 'Survive the longest', 'Survivalist'),
(10, 'Complete the game without taking damage', 'Untouchable'),
(11, 'Complete the game in under 3 hours', 'Speedrunner'),
(12, 'Defeat the final boss on the first attempt', 'One Shot Hero'),
(13, 'Complete the game without using any items', 'Pacifist'),
(14, 'Complete the game on the hardest difficulty', 'Hardcore'),
(15, 'Defeat the final boss without using magic', 'Warrior'),
(16, 'Complete all missions without being detected', 'Ghost'),
(17, 'Win 100 matches in a row', 'Champion'),
(18, 'Survive until the end', 'Survivor'),
(19, 'Complete the game without killing anyone', 'Peacekeeper'),
(20, 'Complete the game without using weapons', 'Pacifist'),
(1, 'Complete all side quests', 'Side Quest Master'),
(2, 'Defeat all dragons', 'Dragon Hunter'),
(3, 'Find all easter eggs', 'Easter Egg Hunter'),
(4, 'Unlock all achievements', 'Achievement Hunter'),
(5, 'Complete all challenges', 'Challenge Master'),
(6, 'Score a hat-trick', 'Hat-trick Hero'),
(7, 'Defeat the final boss in under 10 minutes', 'Speedrunner'),
(8, 'Win 100 matches', 'Legend'),
(9, 'Survive until the end', 'Survivor'),
(10, 'Complete the game without dying', 'Perfectionist'),
(11, 'Complete the game in under 5 hours', 'Speedrunner'),
(12, 'Defeat the final boss without taking damage', 'Untouchable'),
(13, 'Complete the game without killing anyone', 'Pacifist'),
(14, 'Complete the game on the hardest difficulty', 'Hardcore Gamer'),
(15, 'Defeat the final boss on the first try', 'One Shot Wonder'),
(16, 'Deliver all packages in under 1 hour', 'Speedy Delivery'),
(17, 'Discover all hidden treasures', 'Treasure Hunter'),
(18, 'Complete the game without using magic', 'Warrior'),
(19, 'Complete all missions without being detected', 'Ghost'),
(20, 'Win 100 matches in a row', 'Unstoppable');

INSERT INTO user_achievement (lib_id, achieve_id, received_date)
VALUES
(1, 1, '2023-06-01'),
(2, 2, '2023-06-10'),
(3, 3, '2024-01-01'),
